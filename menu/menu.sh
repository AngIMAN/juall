...
echo -e " $COLOR1╰═══════════════╯╰════════════════════════════════════════╯${NC}"
echo -e " $COLOR1      ═══════════════════════════════════════════════${NC}"
echo -e " $COLOR1 $NC ${COLOR1}[${WH}07${COLOR1}]${NC}${COLOR1}• ${WH}DELETE ALL EXPIRED AKUN $COLOR1│$NC ${COLOR1}[${WH}11${COLOR1}]${NC}${COLOR1}• ${WH}BOT PANEL"
...
echo -e " $COLOR1 $NC ${COLOR1}[${WH}00${COLOR1}]${NC}${COLOR1}• ${WH}EXIT                    $COLOR1│$NC ${COLOR1}[${WH}15${COLOR1}]${NC}${COLOR1}• ${WH}UPDATE SCRIPT"
echo -e " $COLOR1      ═══════════════════════════════════════════════${NC}"
if [ "$Isadmin" = "ON" ]; then 
