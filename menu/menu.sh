...
echo -e " $COLOR1╰═══════════════╯╰══════╯╰══════════════╯╰════════════════╯${NC}"
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}7${COLOR1}]${NC}${COLOR1}• ${WH}DELETE ALL EXP AKUN   $COLOR1│$NC  ${COLOR1}[${WH}11${COLOR1}]${NC}${COLOR1}• ${WH}BOT PANEL"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}8${COLOR1}]${NC}${COLOR1}• ${WH}RUNNING AKUN          $COLOR1│$NC  ${COLOR1}[${WH}12${COLOR1}]${NC}${COLOR1}• ${WH}BOT NOTIF "
echo -e " $COLOR1│$NC ${COLOR1}[${WH}9${COLOR1}]${NC}${COLOR1}• ${WH}RESTART AKUN          $COLOR1│$NC  ${COLOR1}[${WH}13${COLOR1}]${NC}${COLOR1}• ${WH}MENU BACKUP "
echo -e " $COLOR1│$NC ${COLOR1}[${WH}10${COLOR1}]${NC}${COLOR1} ${WH}MENU SYSTEM           $COLOR1│$NC  ${COLOR1}[${WH}14${COLOR1}]${NC}${COLOR1}• ${WH}REBOOT VPS"   
echo -e " $COLOR1│$NC ${COLOR1}[${WH}0${COLOR1}]${NC}${COLOR1}• ${WH}EXIT                  $COLOR1│$NC  ${COLOR1}[${WH}15${COLOR1}]${NC}${COLOR1}• ${WH}UPDATE SCRIPT"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
if [ "$Isadmin" = "ON" ]; then 
