...
echo -e " $COLOR1  $NC${WH} ❤️ Bandwidth   ${COLOR1}: ${WH}Today ${WH}$today_tx $today_txv, this month ${green}$month_tx $month_txv$COLOR1${NC}"
echo -e " $COLOR1  $NC${WH} 🩷 Masa Aktif  ${COLOR1}: ${WH}$certificate Hari / $Exp2  •$sts ${NC}$COLOR1" 
echo -e " $COLOR1   ═════════════════════════════════════════════════════${NC}"
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│ ${yl}             Username  :  • $author •         $NC"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e " "
echo -e " ${WH}  SSH-WS : ${status_ws}${WH}${WH}  XRAY : ${status_xray}${WH} ${WH}  NGINX : ${status_nginx}${WH}  DROPBEAR : ${status_beruangjatuh}${WH}  UDP : ${status_udp}"
echo -e "    "
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
...
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}07${COLOR1}]${NC}${COLOR1}• ${WH}MENU SYSTEM ${COLOR1}│${NC} ${COLOR1}[${WH}11${COLOR1}]${NC}${COLOR1}• ${WH}BOT PANEL  ${COLOR1}│${NC} ${COLOR1}[${WH}15${COLOR1}]${NC}${COLOR1}• cooming soon${WH}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}08${COLOR1}]${NC}${COLOR1}• ${WH}MENU BACKUP ${COLOR1}│${NC} ${COLOR1}[${WH}12${COLOR1}]${NC}${COLOR1}• ${WH}BOT NOTIF  ${COLOR1}│${NC} ${COLOR1}[${WH}16${COLOR1}]${NC}${COLOR1}• cooming soon${WH}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}09${COLOR1}]${NC}${COLOR1}• ${WH}RESTART     ${COLOR1}│${NC} ${COLOR1}[${WH}13${COLOR1}]${NC}${COLOR1}• ${WH}REBOOT     ${COLOR1}│${NC} ${COLOR1}[${WH}17${COLOR1}]${NC}${COLOR1}• cooming soon${WH}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}10${COLOR1}]${NC}${COLOR1}• ${WH}RUNNING     ${COLOR1}│${NC} ${COLOR1}[${WH}14${COLOR1}]${NC}${COLOR1}• ${WH}UPDATE     ${COLOR1}│${NC} ${COLOR1}[${WH}18${COLOR1}]${NC}${COLOR1}• cooming soon${WH}"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
if [ "$Isadmin" = "ON" ]; then 
