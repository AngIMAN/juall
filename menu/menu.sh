...
echo -e "    "
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e " $COLOR1│$NC       ${COLOR1}MENU AKUN${NC}   ${COLOR1}│${NC} ${COLOR1}STATUS ${NC} ${COLOR1}TOTAL PREMIUM ${NC} ${COLOR1}BANDWIDTH USAGE ${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}01${COLOR1}]${NC}${COLOR1}• ${WH}SSH         ${COLOR1}│${NC}   ${status_ws}${COLOR1}     $total_ssh Accounts      ${NC} ${COLOR1}TODAY${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}02${COLOR1}]${NC}${COLOR1}• ${WH}VMESS       ${COLOR1}│${NC}   ${status_xray}${COLOR1}     $vmess Accounts     ${NC} $today_tx $today_txv${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}03${COLOR1}]${NC}${COLOR1}• ${WH}VLESS       ${COLOR1}│${NC}   ${status_xray}${COLOR1}     $vless Accounts     ${NC} ${COLOR1}YESTERDAY${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}04${COLOR1}]${NC}${COLOR1}• ${WH}TROJAN      ${COLOR1}│${NC}   ${status_xray}${COLOR1}     $trtls Accounts     ${NC} $yesterday_tx $yesterday_txv${NC}"
echo -e " $COLOR1│$NC ${COLOR1}[${WH}05${COLOR1}]${NC}${COLOR1}• ${WH}NOOBZVPNS   ${COLOR1}│${NC}   ${stat_noobz}${COLOR1}     $jumlah_noobz Accounts     ${NC} ${COLOR1}THIS MONTH${NC}" 
echo -e " $COLOR1│$NC ${COLOR1}[${WH}06${COLOR1}]${NC}${COLOR1}• ${WH}TROJAN-GO   ${COLOR1}│${NC}   ${stat_trgo}${COLOR1}     $jumlah_trgo Accounts     ${NC} $month_tx $month_txv${NC}"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
echo -e " $COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
