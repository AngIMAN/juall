...
echo -e " $COLOR1│$NC ${COLOR1}[${WH}04${COLOR1}]${NC} ${COLOR1}• ${WH}TROJAN    ${WH}│${NC}${COLOR1} ($trtls) ${NC}$COLOR1│${NC}  ${WH}[${COLOR1}10${WH}]${NC} ${COLOR1}• ${WH}SYSTEM${WH}[${COLOR1}Menu${WH}] $COLOR1│${NC}" 
echo -e " $COLOR1│$NC ${COLOR1}[${WH}05${COLOR1}]${NC} ${COLOR1}• ${WH}NOOBZVPNS ${WH}│${NC}${COLOR1} ($jumlah_noobz) ${NC}$COLOR1│${NC}  ${WH}[${COLOR1}11${WH}]${NC} ${COLOR1}• ${WH}BACKUP${WH}[${COLOR1}Menu${WH}] $COLOR1│${NC}" 
echo -e " $COLOR1│$NC ${COLOR1}[${WH}06${COLOR1}]${NC} ${COLOR1}• ${WH}TROJAN-GO ${WH}│${NC}${COLOR1} ($jumlah_trgo) ${NC}$COLOR1│${NC}  ${WH}[${COLOR1}12${WH}]${NC} ${COLOR1}• ${WH}REBOOT${WH}[${COLOR1}Menu${WH}] $COLOR1│${NC}" 
echo -e " $COLOR1│$NC ${COLOR1}[${WH}22${COLOR1}]${NC} ${COLOR1}• ${WH}RUNNING   ${WH}│${NC}${COLOR1}Menu${WH}]  ${NC}   $COLOR1│${NC}  ${WH}[${COLOR1}23${WH}]${NC} ${COLOR1}• ${WH}RESTAR${WH}[${COLOR1}Menu${WH}] $COLOR1│${NC}"
echo -e " $COLOR1╰═════════════════════════════════════════════════════════╯${NC}"
if [ "$Isadmin" = "ON" ]; then
